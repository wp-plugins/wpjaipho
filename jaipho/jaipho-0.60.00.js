/******************************************************************************
 *	JAIPHO BETA, version 0.60.00 Android support
 *	(c) 2009,2012 jaipho.com
 *
...
//	this.mrAnimation.Init();
	...
	slider_mover.AttachListener( 'MoveCancel', this.mrApp.mrSlider.mrSlidesComponent, 'RepaintPosition');
	slider_mover.Init();
...
//  	debug( 'resize: slide - ContainerResized()');
